...
const EstimateForm = forwardRef<HTMLDivElement>((_, ref) => {
  // ====== 좌측(거래처) ======
      ...
      <div className="flex gap-3 mb-3">
        ...
        <div className="flex-1 border border-gray-400 rounded-sm">
          ...
          <div className="px-3 py-2 border-t border-gray-300 text-[12px]">
            <p className="font-bold">견적요청에 감사드리며 아래와 같이 견적합니다.</p>
          </div>
        </div>

        {/* 우측 공급자 - ✅ 아래쪽 의미없는 빨간 블록 없음(테이블만) */}
