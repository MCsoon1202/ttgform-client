...
const RequestOrderForm = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    <div
      ...
      data-testid="request-order-form"
    >
      ...
      <div className="flex gap-3 mb-3">
        <div className="flex-1 border border-gray-400 rounded-sm">
          ...
          <div className="px-3 py-2 border-t border-gray-300 text-[12px]">
            <p className="font-bold">납기일 내에 공급을 부탁 드립니다.</p>
          </div>
        </div>
...
RequestOrderForm.displayName = "RequestOrderForm";
export { RequestOrderForm };
